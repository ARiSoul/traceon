...
public sealed class ActionField : Entity
{
    ...
    public string? DisplayStyleConfigJson { get; private set; }
    ...
    private ActionField(
        ...
        int displayStyle, string? displayStyleConfigJson)
    {
        ...
        DisplayStyleConfigJson = displayStyleConfigJson;
    }
    ...
    public static ActionField Create(
        ...
        int displayStyle = 0,
        string? displayStyleConfigJson = null)
    {
        ...
        return new ActionField(trackedActionId, fieldDefinitionId, name.Trim(),
            ...
            displayStyle, displayStyleConfigJson);
    }
