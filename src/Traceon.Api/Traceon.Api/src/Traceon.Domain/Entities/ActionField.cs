...
public sealed class ActionField : Entity
{
    ...
    private ActionField(
        ...
        decimal? targetValue, int initialValueBehavior, int initialValuePeriodUnit,
    ...
    public static ActionField Create(
        ...
        int trendChartType = 0, decimal? targetValue = null, int initialValueBehavior = 0,
        ...
        int dropdownTrendChartType = 0)
    {
        ...
        return new ActionField(trackedActionId, fieldDefinitionId, name.Trim(),
            ...
            trendAggregation, trendChartType, targetValue, initialValueBehavior,
    ...
    public void Update(
        ...
        decimal? targetValue = null, int? initialValueBehavior = null,
