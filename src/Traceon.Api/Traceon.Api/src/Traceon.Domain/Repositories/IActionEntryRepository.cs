...
public interface IActionEntryRepository
{
    ...
    Task UpdateAsync(ActionEntry entry, IReadOnlyList<(Guid ActionFieldId, IReadOnlyList<string> Values)>? fieldValues = null, CancellationToken cancellationToken = default);
