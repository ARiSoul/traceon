...
public sealed record ActionFieldResponse
{
    ...
    public required TargetValueMode TargetValueMode { get; init; }
    ...
    public required DisplayStyle DisplayStyle { get; init; }
    public DisplayStyleConfig? DisplayStyleConfig { get; init; }
