...
namespace Traceon.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260426195638_AddActionFieldDisplayStyle")]
    partial class AddActionFieldDisplayStyle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Traceon.Domain.Entities.ActionEntry", b =>
                {
                    ...
                    b.Property<Guid?>("ReceiptImportBatchId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ReceiptImportBatchId");
            ...
            modelBuilder.Entity("Traceon.Domain.Entities.ActionEntryFieldValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ActionEntryFieldId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ActionEntryFieldId");

                    b.HasIndex("Value");

                    b.ToTable("ActionEntryFieldValues", "Traceon");
                });
            ...
            modelBuilder.Entity("Traceon.Domain.Entities.ActionField", b =>
                {
                    ...
                    b.Property<string>("AutoCounterConfigJson")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
                    ...
                    b.Property<string>("DisplayStyleConfigJson")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("Traceon.Domain.Entities.EntryTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EntryTemplates", "Traceon");
                });

            modelBuilder.Entity("Traceon.Domain.Entities.EntryTemplateField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("EntryTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EntryTemplateId");

                    b.ToTable("EntryTemplateFields", "Traceon");
                });

            modelBuilder.Entity("Traceon.Domain.Entities.EntryTemplateFieldValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("EntryTemplateFieldId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EntryTemplateFieldId");

                    b.ToTable("EntryTemplateFieldValues", "Traceon");
                });
            ...
            modelBuilder.Entity("Traceon.Domain.Entities.ReceiptImportConfig", b =>
                {
                    ...
                    b.Property<Guid?>("ReceiptDiscountTypeFieldId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ReceiptDiscountTypeValue")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasIndex("ReceiptDiscountTypeFieldId");
            ...
            modelBuilder.Entity("Traceon.Domain.Entities.ActionEntryFieldValue", b =>
                {
                    b.HasOne("Traceon.Domain.Entities.ActionEntryField", null)
                        .WithMany("Values")
                        .HasForeignKey("ActionEntryFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Traceon.Domain.Entities.EntryTemplateField", b =>
                {
                    ...
                    b.HasOne("Traceon.Domain.Entities.EntryTemplate", null)
                        .WithMany("Fields")
                        .HasForeignKey("EntryTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Traceon.Domain.Entities.EntryTemplateFieldValue", b =>
                {
                    b.HasOne("Traceon.Domain.Entities.EntryTemplateField", null)
                        .WithMany("Values")
                        .HasForeignKey("EntryTemplateFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Traceon.Domain.Entities.ReceiptImportConfig", b =>
                {
                    ...
                    b.HasOne("Traceon.Domain.Entities.ActionField", null)
                        .WithMany()
                        .HasForeignKey("ReceiptDiscountTypeFieldId")
                        .OnDelete(DeleteBehavior.NoAction);
