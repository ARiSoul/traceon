...
namespace Arisoul.Traceon.Maui.Infrastructure.Migrations
{
    ...
    [Migration("20250504172728_AddAuditEntityId")]
    partial class AddAuditEntityId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Arisoul.Traceon.Maui.Core.Entities.ActionField", b =>
                {
                    ...
                    b.HasKey("ActionId", "FieldDefinitionId");

                    b.HasIndex("FieldDefinitionId");

                    b.ToTable("ActionFields");
                });
